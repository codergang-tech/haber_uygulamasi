...
import 'package:haber_uygulamasi/genelHaber/model/source_model.dart';
...
class GenelArticles {
  ...
  GenelSource? get source => _source;
  set source(GenelSource? source) => _source = source;
  ...
  GenelArticles.fromJson(Map<String, dynamic> json) {
    _source = json['source'] != null
        ? GenelSource.fromJson(json['source'])
        : null;
    _author = json['author'];
    _title = json['title'];
